...
//#warning "Please check if the SystemClock_Config() settings match your board!"
  ...
  RCC_OscInitStruct.PLL.PLLM = (HSE_VALUE/1000000u); // so 1 MHz input clock
#else
  ...
  RCC_OscInitStruct.PLL.PLLN = 400; // multiply input clock with 400 == 400MHz
#if defined(STM32F401xC) || defined(STM32F401xE) || defined(STM32F411xE)
  RCC_OscInitStruct.PLL.PLLP = RCC_PLLP_DIV4; // divide with 4 -> 100MHz
